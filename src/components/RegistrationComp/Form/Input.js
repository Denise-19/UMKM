...
const Input = ({ type = 'text', placeholder, name, value, onChange, error, label, subLabel, noteLabel }) => {
    return (
        <div className="mb-5">
            ...
            <input
                ...
                autoComplete="off"
            />
            <span style={{ fontFamily: 'Poppins', fontWeight: 300, fontSize: 10, color: '#555555' }}>{noteLabel}</span>
